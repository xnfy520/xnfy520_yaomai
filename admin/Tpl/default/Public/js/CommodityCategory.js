$(function(){
    ...
    $("#CommodityCategory-add-edit [title]").live('hover',function(){
        $(this).tooltip({
    ...
    //AJAX删除
    $("[name=CommodityCategory-del]").live('submit',function(){
    ...
    $(".switch_status").live("click",function(){
        ...
        var submit = function (v, h, f) {
            if (v == 'ok'){
                ...
                window.setTimeout(function () {
                    $.ajax({
                        url: define_app_url+'/CommodityCategory/ajax_switch_status',
