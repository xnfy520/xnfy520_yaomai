            ...
            <table>
             ...
             <!--    <tr>
                    ...
                    <td class="table_td">
                        ...
                        <span class="table_image_tip_size">请上传尺寸为 宽高为 1.4：1 的图片</span>
                    </td>
                </tr>
                ...
                <tr class="table_tr"><th class="table_th">链接地址：</th><td class="table_td"><input type="text" name="link" title="必须以 http:// 开头 双击可显示 (可为空)" /></td></tr>
...
<script>
    ...
    //         action: define_app_url+'/SystemAnnouncement/uploads',
    //         name: 'myfile',
