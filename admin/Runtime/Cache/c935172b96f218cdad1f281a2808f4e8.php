...
<div id="xnfy520-function-index">
    ...
    <div id="xnfy520-function-index-nav">
        <a href="__APP__/CommoditySubclass/index">全部</a>
        <?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voc): $mod = ($i % 2 );++$i;?><a href="__APP__/CommoditySubclass/index/pid/<?php echo ($voc["id"]); ?>"><?php echo ($voc["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
    ...
    <div id="xnfy520-function-index-search">
        ...
        <form action="__APP__/CommodityCategory/index<?php if(!empty($_GET['pid'])): ?>/pid/<?php echo ($_GET['pid']); endif; ?>" method="post" name="form_search"  style="line-height: 35px;">
    ...
    <div id="xnfy520-function-index-content">
        ...
        <form action="javascript:;" method="post" name="CommoditySubclass-del" class="delete">
            <table id="xnfy520-function-index-table">
                <thead>
                <tr>
                    <th id="xnfy520-function-index-table-th-name" colspan="2">名称</th>
                    <th id="xnfy520-function-index-table-th-enable">启用</th>
                    <th id="xnfy520-function-index-table-th-50">排序</th>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="xnfy520-function-index-table-td-name">
                                   <span class="xnfy520-function-index-edit">
                                       <?php if((mb_strlen($vo["name"],'utf-8')) > "20"): ?><span title="<?php echo ($vo["name"]); ?>"><?php echo (mb_substr($vo["name"],0,20,"utf-8")); ?>...</span>
                                           <?php else: ?>
                                           <span><?php echo ($vo["name"]); ?></span><?php endif; ?>
                                    </span>
                            </td>
                            <td class="xnfy520-function-index-table-td-ini-50" title="<?php echo (count($vo['CommodityList'])); ?> 个商品">
                                <?php echo (count($vo['CommodityList'])); ?>
                            </td>
                            ...
                            <td class="xnfy520-function-index-table-td-checkbox">
                                <?php if(($vo["level"]) == "0"): ?><input style="display: none;" disabled="disabled" class="xnfy520-function-index-table-check-this" type="checkbox" name="deleteid[]" value="<?php echo ($vo["id"]); ?>" />
                                    <?php else: ?>
