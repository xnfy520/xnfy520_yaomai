...
<div id="HomeGrownProduct-add-edit">
    ...
    <form action="javascript:;" method="POST" name="CommodityList-add">
        ...
        <ul style="margin-top: 10px;">
            ...
            <li class="xnfy520-function-index-add-edit-ul-li" style="margin-top: 3px;">
                <strong>售　　价：</strong>
                    <input type="text" name="price" value="0" style="width: 47px;text-align: center;height: 18px;" maxlength="8" />　
                <strong>排　　序：</strong>
                <input title="值必须在0-255 (必填)" type="text" name="sort" value="99" style="width: 49px;text-align: center;height: 18px;" maxlength="3" />　
                <strong>商品体积：</strong>
                <input type="text" name="" value="" style="width: 47px;text-align: center;height: 18px;" maxlength="3" />
            </li>
