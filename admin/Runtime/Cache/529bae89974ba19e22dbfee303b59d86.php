    ...
    <div class="menu">
        <ul>
            ...
            <?php if(($Userinfo["Role"]["level"]) != $p_level): ?><li>
                    ...
                    <a class="xnfy520_left_title" href="javascript:;">积分礼品</a>

                    <ul>

                        <li><a  id="Left-IntegralLimit" class="top-action" href="__APP__/IntegralLimit/index">积分范围</a></li>
                        <li><a  id="Left-IntegralGiftCategory" class="top-action" href="__APP__/IntegralGiftCategory/index">礼品分类</a></li>
                        <li><a  id="Left-IntegralGiftList" class="top-action" href="__APP__/IntegralGiftList/index">礼品列表</a></li>
                        <li><hr /></li>
                        <li><a  id="Left-IntegralExchangeLogs" class="top-action" href="__APP__/IntegralExchangeLogs/index">兑换记录</a></li>
...
<div id="xnfy520-function-index">
    ...
    <div id="xnfy520-function-index-search">
        ...
        <form action="__APP__/SystemAnnouncement/index" method="post" name="form_search"  style="line-height: 35px;">
    ...
    <div id="xnfy520-function-index-content">
        ...
        <form action="javascript:;" method="post" name="SystemAnnouncement-del" class="delete">
