...
<div id="xnfy520-function-index">
    ...
    <div style="display: none;">
        <div id="this_form_datas" level="<?php echo (C("address_level.province_level")); ?>" add_action_from="add" add_action_to="ajax_insert" edit_action_from="edit" edit_action_to="ajax_edit"></div>
    </div>
    ...
    <div id="xnfy520-function-index-search">
        ...
        <form action="__APP__/Address/index" method="post" name="form_search"  style="line-height: 35px;">
               ...
               <tbody>
                   <?php if(empty($list)): ?><tr><td colspan="9" style="height:50px;">暂无数据</td></tr>
                       ...
                       <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                               ...
                               <td class="xnfy520-function-index-table-td-ini-50">
                                   <a href="__APP__/Address/city/pid/<?php echo ($vo["id"]); ?>">进入</a>
                               </td>
                               ...
                               <td class="xnfy520-function-index-table-td-sort">
                                   <span class="xnfy520-function-index-edit"><?php echo ($vo["sort"]); ?></span>
                              </td>
                              <td>
                               ...
                               <td class="xnfy520-function-index-table-td-checkbox">
                                   <input <?php if(in_array(($vo["id"]), explode(',',"1,2,3,4"))): ?>style="display:none" disabled="disabled" readonly="readonly"<?php endif; ?> class="xnfy520-function-index-table-check-this" type="checkbox" name="deleteid[]" value="<?php echo ($vo["id"]); ?>" this_pid="<?php echo ($vo["pid"]); ?>" />
                               </td>
