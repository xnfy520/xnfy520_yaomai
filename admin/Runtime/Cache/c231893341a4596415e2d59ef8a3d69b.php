...
<div id="xnfy520-function-index">
    ...
    <div id="xnfy520-function-index-search">
        ...
        <span id="xnfy520-function-index-add"><a href="__APP__/VoteCommodity/add">添 加</a></span>

        <form action="__APP__/VoteCommodity/index" method="post" name="form_search"  style="line-height: 35px;">
    ...
    <div id="xnfy520-function-index-content">
        ...
        <form action="javascript:;" method="post" name="VoteCommodity-del" class="delete">
