...
<div id="xnfy520-function-index">
    ...
    <div id="xnfy520-function-index-search">
        ...
        <form action="__APP__/AdvertCategory/index" method="post" name="form_search"  style="line-height: 35px;">
    ...
    <div id="xnfy520-function-index-content">
        ...
        <form action="javascript:;" method="post" name="AdvertCategory-del" class="delete">
            <table id="xnfy520-function-index-table">
                <thead>
                <tr>
                    <th id="xnfy520-function-index-table-th-name" colspan="2">名称</th>
                    <th class="xnfy520-function-index-table-th-150">类型</th>
                ...
                <?php if(empty($list)): ?><tr><td colspan="7" style="height:50px;">暂无数据</td></tr>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td class="xnfy520-function-index-table-td-ini-50" title="<?php echo (count($vo['AdvertList'])); ?> 个广告">
                                <?php echo (count($vo['AdvertList'])); ?>
                            </td>
                            <td>
                                <?php if(is_array($advert_category)): $i = 0; $__LIST__ = $advert_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i; if(($vos["type"]) == $vo["type"]): echo ($vos["name"]); endif; endforeach; endif; else: echo "" ;endif; ?>
                            </td>
