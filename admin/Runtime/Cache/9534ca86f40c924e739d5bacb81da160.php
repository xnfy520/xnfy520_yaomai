...
<div id="xnfy520-function-index">
    ...
    <div style="display: none;">
        <div id="this_form_datas" level="<?php echo (C("provinces_level.area_level")); ?>" add_action_from="add" add_action_to="ajax_insert" edit_action_from="edit" edit_action_to="ajax_edit"></div>
    </div>
    ...
    <div id="xnfy520-function-index-search">
        ...
        <form action="__APP__/Provinces/index" method="post" name="form_search"  style="line-height: 35px;">
            ...
            <table id="xnfy520-function-index-table">
                <thead>
                    <tr>
                        ...
                        <th id="xnfy520-function-index-table-th-description">省份列表</th>
               ...
               <tbody>
                   <?php if(empty($list)): ?><tr><td colspan="7" style="height:50px;">暂无数据</td></tr>
                       ...
                       <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                               ...
                               <td class="xnfy520-function-index-table-td-ini-50">
                                   <a href="__APP__/Provinces/province/pid/<?php echo ($vo["id"]); ?>">进入</a>
                               </td>
                               ...
                               <td class="xnfy520-function-index-table-td-sort">
                                   <span class="xnfy520-function-index-edit"><?php echo ($vo["sort"]); ?></span></td>
                               <td>
                               </td>
