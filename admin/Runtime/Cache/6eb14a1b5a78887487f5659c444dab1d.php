...
<div id="xnfy520-function-index">
    ...
    <div id="xnfy520-function-index-title">
        <?php echo ($cinfo["name"]); ?> 商品列表
    </div>

    <div id="xnfy520-function-index-nav">
        <a href="__APP__/CommodityList/index">全部</a>
        <?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voc): $mod = ($i % 2 );++$i;?><a href="__APP__/CommodityList/index/pid/<?php echo ($voc["id"]); ?>"><?php echo ($voc["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>

    <?php if(!empty($_GET['pid'])): ?><div id="xnfy520-function-index-nav-sub" style="margin-top: -3px;">
            <a href="__APP__/CommodityList/index<?php if(!empty($_GET['pid'])): ?>/pid/<?php echo ($_GET['pid']); endif; ?>">全部</a>
            <div style="margin-left: 85px;">
                <?php if(is_array($cclist)): $i = 0; $__LIST__ = $cclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vocc): $mod = ($i % 2 );++$i;?><a href="__APP__/CommodityList/index<?php if(!empty($_GET['pid'])): ?>/pid/<?php echo ($_GET['pid']); endif; ?>/cid/<?php echo ($vocc["id"]); ?>"><?php echo ($vocc["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div><?php endif; ?>

    <div id="xnfy520-function-index-search">

        <span id="xnfy520-function-index-add"><a href="__APP__/CommodityList/add<?php if(!empty($_GET['pid'])): ?>/pid/<?php echo ($_GET['pid']); endif; if(!empty($_GET['cid'])): ?>/cid/<?php echo ($_GET['cid']); endif; ?>">添 加</a></span>

        <form action="__APP__/CommodityList/index<?php if(!empty($_GET['pid'])): ?>/pid/<?php echo ($_GET['pid']); endif; ?>" method="post" name="form_search"  style="line-height: 35px;">
    ...
    <div id="xnfy520-function-index-content">
        ...
        <form action="javascript:;" method="post" name="CommodityList-del" class="delete">
            <table id="xnfy520-function-index-table">
                ...
                <tr>
                    ...
                    <th class="xnfy520-function-index-table-th-50">描述</th>
                    ...
                    <th class="xnfy520-function-index-table-th-50">售价</th>
                    <th class="xnfy520-function-index-table-th-50">销量</th>
                ...
                <?php if(empty($list)): ?><tr><td colspan="11" style="height:50px;">暂无数据</td></tr>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><a href="__APP__/CommodityDetails/index/did/<?php echo ($vo["id"]); ?>">查看</a></td>
                           ...
                           <!--  <td class="xnfy520-function-index-table-td-hover">
                            ...
                            <td>
                                <?php echo ($vo["sales_volume"]); ?>
                            </td>
                            <td><?php echo (date("Y-m-d H:i:s",$vo["create_date"])); ?></td>
                            <td class="xnfy520-function-index-table-td-checkbox">
                                <input <?php if(($vo["sales_volume"]) > "0"): ?>disabled="disabled" style="display:none"<?php endif; ?>  class="xnfy520-function-index-table-check-this" type="checkbox" pid="<?php echo ($vo["pid"]); ?>" cid="<?php echo ($vo["cid"]); ?>" name="deleteid[]" value="<?php echo ($vo["id"]); ?>" />
                            </td>
