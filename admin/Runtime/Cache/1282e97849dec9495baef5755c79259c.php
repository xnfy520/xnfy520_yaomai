    ...
    <div id="xnfy520-function-index-content">
        ...
        <form action="javascript:;" method="post" name="User-del" class="delete">
            <table id="xnfy520-function-index-table">
                ...
                <tbody>
                <?php if(empty($list)): ?><tr><td colspan="4" style="height:50px;">暂无数据</td></tr>
                    <?php else: ?>
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <!--<td><?php if(($vo["logindate"]) == "0"): ?>-<?php else: echo (date("Y-m-d H:i:s",$vo["logindate"])); endif; ?></td>-->
