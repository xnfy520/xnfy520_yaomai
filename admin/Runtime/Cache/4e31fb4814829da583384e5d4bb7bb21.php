...
<div id="xnfy520-function-index">
    ...
    <div style="display: none;">
        <div id="this_form_datas" level="<?php echo (C("provinces_level.county_level")); ?>" add_action_from="add" add_action_to="ajax_insert" edit_action_from="edit" edit_action_to="ajax_edit"></div>
    </div>

    <div id="xnfy520-function-index-title" style="position: relative;">
        县区列表 <span style="position: absolute;right: 3px;">[ <a style="color: white;" href="__APP__/Provinces/city">返回市级列表</a> ]</span>
    </div>

    <!--<div id="xnfy520-function-index-nav">-->
        <!--<a href="__APP__/Provinces/county">全部</a>-->
        <!--<?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voc): $mod = ($i % 2 );++$i;?>-->
            <!--<a href="__APP__/Provinces/county/pid/<?php echo ($voc["id"]); ?>"><?php echo ($voc["name"]); ?></a>-->
    ...
    <div id="xnfy520-function-index-search">
        ...
        <form action="__APP__/Provinces/county<?php if(!empty($_GET['pid'])): ?>/pid/<?php echo ($_GET['pid']); endif; ?>" method="post" name="form_search"  style="line-height: 35px;">
