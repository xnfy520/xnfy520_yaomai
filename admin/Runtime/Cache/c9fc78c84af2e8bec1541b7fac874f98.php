...
<div id="xnfy520-function-index">
    ...
    <div style="display: none;">
        <div id="this_form_datas" level="<?php echo (C("provinces_level.city_level")); ?>" add_action_from="add" add_action_to="ajax_insert" edit_action_from="edit" edit_action_to="ajax_edit"></div>
    </div>

    <div id="xnfy520-function-index-title" style="position: relative;">
        市级列表 <span style="position: absolute;right: 3px;">[ <a style="color: white;" href="__APP__/Provinces/province">返回省级列表</a> ]</span>
    </div>

    <div id="xnfy520-function-index-nav">
        <a href="__APP__/Provinces/city">全部</a>
        <?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voc): $mod = ($i % 2 );++$i;?><a href="__APP__/Provinces/city/pid/<?php echo ($voc["id"]); ?>"><?php echo ($voc["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
    ...
    <div id="xnfy520-function-index-search">
        ...
        <form action="__APP__/Provinces/city<?php if(!empty($_GET['pid'])): ?>/pid/<?php echo ($_GET['pid']); endif; ?>" method="post" name="form_search"  style="line-height: 35px;">
        ...
        <form action="javascript:;" method="post" name="Provinces-del" class="delete">
            <table id="xnfy520-function-index-table">
                ...
                <tr>
                    ...
                    <th id="xnfy520-function-index-table-th-description">县区列表</th>
                ...
                <?php if(empty($list)): ?><tr><td colspan="9" style="height:50px;">暂无数据</td></tr>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td class="xnfy520-function-index-table-td-ini-50">
                                <a href="__APP__/Provinces/county/pid/<?php echo ($vo["id"]); ?>">进入</a>
                            </td>
