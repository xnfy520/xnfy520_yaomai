            ...
            <?php if(($Userinfo["Role"]["level"]) != $p_level): ?><li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <?php else: ?>
                            ...
                            <?php if(is_array($Rolelist)): $i = 0; $__LIST__ = $Rolelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo_user_list): $mod = ($i % 2 );++$i; if(($vo_user_list["level"]) == $m_level): ?><li>
                                        <a  id="Left-User-index-rid-<?php echo ($vo_user_list["id"]); ?>" class="top-action" href="__APP__/User/index/rid/<?php echo ($vo_user_list["id"]); ?>"><?php echo ($vo_user_list["name"]); ?></a>
                        ...
                        <!--<li>-->
                        <!--<a  id="Left-Merchant " class="top-action" href="__APP__/Merchant/index">商户中心</a>-->
                        <!--</li>-->
                    </ul>
                </li>
                <?php if(($Userinfo["Role"]["level"]) != $p_level): ?><li>

                    <a class="xnfy520_left_title" href="javascript:;">风土人情</a>

                    <ul>

                        <li><a  id="Left-FolkCustomDirection" class="top-action" href="__APP__/FolkCustomDirection/index">民俗区域</a></li>
                        <li><a  id="Left-FolkCustomProvinces" class="top-action" href="__APP__/FolkCustomProvinces/index">民俗省市</a></li>
                        <li><a  id="Left-FolkCustomInformation" class="top-action" href="__APP__/FolkCustomInformation/index">民俗资讯</a></li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><hr /></li>
                        <li><a  class="set-index-commodity" type="favorable" class="top-action" href="javascript:;">首页-超值优惠</a></li>
                        <li><a  class="set-index-commodity" type="recommend" class="top-action" href="javascript:;">首页-精品推荐</a></li>
                        <li><a  class="set-index-commodity" type="specialty" class="top-action" href="javascript:;">首页-区域特产</a></li>
                        <li><a  class="set-index-commodity" type="commodity_recommend" class="top-action" href="javascript:;">风土人情详情页-商品推荐</a></li>
                        <li><a  class="set-index-commodity" type="member_commodity_recommend" class="top-action" href="javascript:;">用户中心-商品推荐</a></li>
                        <li><a  class="set-index-commodity" type="cart_commodity_recommend" class="top-action" href="javascript:;">购物车-商品推荐</a></li>
                    </ul>
...
<div id="xnfy520-function-index">
    ...
    <div id="xnfy520-function-index-search">
        ...
        <form action="__APP__/TemplateList/index<?php if(!empty($_GET['pid'])): ?>/pid/<?php echo ($_GET['pid']); endif; if(!empty($_GET['cid'])): ?>/cid/<?php echo ($_GET['cid']); endif; if(!empty($_GET['sid'])): ?>/sid/<?php echo ($_GET['sid']); endif; ?>" method="post" name="form_search"  style="line-height: 35px;">
    ...
    <div id="xnfy520-function-index-content">
        ...
        <form action="javascript:;" method="post" name="TemplateList-del" class="delete">
            <table id="xnfy520-function-index-table">
                ...
                <tbody>
                <?php if(empty($list)): ?><tr><td colspan="3" style="height:50px;">暂无数据</td></tr>
                    <?php else: ?>
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <!--<td class="xnfy520-function-index-table-td-sort">-->
                                <!--<?php if(($vo["publish"]) == "1"): ?>-->
                                    <!--<span class="switch_status" by="<?php echo ($vo["id"]); ?>" type="publish" value="<?php echo ($vo["publish"]); ?>">是</span>-->
                                    <!--<?php else: ?>-->
                                    <!--<span class="switch_status" by="<?php echo ($vo["id"]); ?>" type="publish" value="<?php echo ($vo["publish"]); ?>">否</span>-->
                                <!--<?php endif; ?>-->
                                <!--<span style="display: none;" data_on="确认关闭？" data_off="确认启用？"></span>-->
                            <!--</td>-->
                            <!--<td class="xnfy520-function-index-table-td-sort">-->
                                <!--<?php if(($vo["recommend"]) == "1"): ?>-->
                                    <!--<span class="switch_status" by="<?php echo ($vo["id"]); ?>" type="recommend" value="<?php echo ($vo["recommend"]); ?>">是</span>-->
                                    <!--<?php else: ?>-->
                                    <!--<span class="switch_status" by="<?php echo ($vo["id"]); ?>" type="recommend" value="<?php echo ($vo["recommend"]); ?>">否</span>-->
                                <!--<?php endif; ?>-->
                                <!--<span style="display: none;" data_on="确认取消推荐？" data_off="确认推荐？"></span>-->
                            <!--</td>-->
