...
<div id="xnfy520-function-index">
    ...
    <div id="xnfy520-function-index-search">
        ...
        <form action="__APP__/GrouponCategory/index" method="post" name="form_search"  style="line-height: 35px;">
    ...
    <div id="xnfy520-function-index-content">
        ...
        <form action="javascript:;" method="post" name="GrouponCategory-del" class="delete">
            <table id="xnfy520-function-index-table">
                ...
                <?php if(empty($list)): ?><tr><td colspan="6" style="height:50px;">暂无数据</td></tr>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td class="xnfy520-function-index-table-td-ini-50" title="<?php echo (count($vo['GrouponCommodity'])); ?>">
                                <?php echo (count($vo['GrouponCommodity'])); ?>
                            </td>
