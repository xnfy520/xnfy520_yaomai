...
<div id="xnfy520-function-index">
    ...
    <div id="xnfy520-function-index-nav">
        <a href="__APP__/GrouponCommodity/index">全部</a>
        <?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voc): $mod = ($i % 2 );++$i;?><a href="__APP__/GrouponCommodity/index/pid/<?php echo ($voc["id"]); ?>"><?php echo ($voc["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>

    <div id="xnfy520-function-index-search">

        <span id="xnfy520-function-index-add"><a href="__APP__/GrouponCommodity/add<?php if(!empty($_GET['pid'])): ?>/pid/<?php echo ($_GET['pid']); endif; ?>">添 加</a></span>

        <form action="__APP__/GrouponCommodity/index<?php if(!empty($_GET['pid'])): ?>/pid/<?php echo ($_GET['pid']); endif; ?>" method="post" name="form_search"  style="line-height: 35px;">
        ...
        <form action="javascript:;" method="post" name="GrouponCommodity-del" class="delete">
            <table id="xnfy520-function-index-table">
                ...
                <tr>
                    ...
                    <th class="xnfy520-function-index-table-th-time">截止日期</th>
                ...
                <?php if(empty($list)): ?><tr><td colspan="11" style="height:50px;">暂无数据</td></tr>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo (date("Y-m-d",$vo["expiration_date"])); ?></td>
