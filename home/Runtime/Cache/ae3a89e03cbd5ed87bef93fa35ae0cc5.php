...
//QC.Login.signOut();
 ...
 <div class="mid-xq">
    	<ul>
          <li class="xq-weizhi">首页 >> <span style="color:#666;">个人中心</span> >> <span style="color:#666;">商品订单</span></li>
            ...
            <li id="xm-dingdan">
              ...
              <div id="xm-dd2">
                <div id="xm-wcdd1">
                  <a class="xm-ds" href="__APP__/Member/commodityOrder">全部订单<span>（<?php echo (($numbers[0])?($numbers[0]):"0"); ?>个）</span></a>  
                  <a class="xm-ds" href="__APP__/Member/commodityOrder/status/1">已付款订单<span>（<?php echo (($numbers[1])?($numbers[1]):"0"); ?>个）</span></a>  
                    <a class="xm-df" href="__APP__/Member/commodityOrder/status/2">待付款订单<span>（<?php echo (($numbers[2])?($numbers[2]):"0"); ?>个</span>）</a> 
                </div>
                          ...
                          <table width="730" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="200" height="35" align="center">
                                ...
                                <?php if(!empty($vo_o["other_data"]["coupon"])): ?>优惠:-<?php echo ($vo_o["other_data"]["coupon"]); endif; ?>
                                )
                                </span>
                              </td>
