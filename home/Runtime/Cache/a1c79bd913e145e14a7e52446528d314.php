...
<div id="xj-tanchu1" style="display:none;z-index:9999">
    ...
    <div id="xj-tanchu5">
        ...
        <div id="show_logistics" style="display:none">
            <div class="xj-faa"> 通过物流运输至物流提货点，自提货，自安装，物流价起步价<span id="x_qbj">0</span>元。</div>
            <div class="xj-faa2">共<span id="x_j">1</span>件商品，<span>1</span>件安体积计算运费，包装体积约<span id="x_tj">0.00</span>立方米，参考费用如下：</div>
            <div class="xj-faa1">
                <ul id="x_q_list">
