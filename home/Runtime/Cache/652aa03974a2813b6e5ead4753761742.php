              ...
              <?php if(is_array($my_addresss)): $i = 0; $__LIST__ = $my_addresss;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo_ad): $mod = ($i % 2 );++$i;?><div id="xm-xdz2" style="margin:0 0 10px">
                      <ul>
                          <li style="margin-right:10px;">
                            <input index="<?php echo ($i-1); ?>" initiate_price="<?php echo ($vo_ad["logistics"]["initiate_price"]); ?>" average_price="<?php echo ($vo_ad["logistics"]["average_price"]); ?>" name="use_address" type="radio" value="<?php echo ($vo_ad["id"]); ?>" />
                          </li>
                          <li>
                            <strong><?php echo ($vo_ad["consignee"]); ?></strong> 
                            地址：
                            <?php echo ($vo_ad["where_text"]); ?> 邮编：<?php echo ($vo_ad["zip"]); ?>
...
<!--         <div class="xm-txxdz3"><a href="#">确认配送方式</a></div> -->
    ...
    <div class="xm-psfs3" style="height:auto;">
        	<ul>
                ...
                <li class="xm-psfs2">
                  ...
                  <label>
                    	<ul>
                        	<li><input name="payment_model" checked="checked" type="radio" value="1" /></li>
                ...
                <li class="xm-psfs1">
                通过网上银行或支付平台在线付款
                  <ul style="margin-top:5px;display:none" id="child-payment">
                    <li style="clear:both;">
                      <input type="radio" name="payment" value="1" checked="checked" /> 支付宝支付
                    </li>
                    <li style="clear:both;margin-top:5px">
                      <input type="radio" name="payment" value="2" /> 网上银行支付
                    </li>
                  </ul>
                </li>
            </ul>
 ...
 -->            </ul>
    ...
    <div id="xm-spqd1">
      ...
      <?php if(is_array($Cartslist)): $i = 0; $__LIST__ = $Cartslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo_cl): $mod = ($i % 2 );++$i;?><div class="xm-spqd7">
        	<ul>
              ...
              <li class="xm-spqd5"><?php echo ($vo_cl["quantity"]); ?></li>
    ...
    <?php if(($Cartslist["0"]["type"]) == "3"): if(!empty($youhui)): ?><div class="xm-ddqs-2" style="width:auto;margin-left:749px">
      ...
      <input type="hidden" name="delivery_price" value="<?php echo ((C("conf7"))?(C("conf7")):"20"); ?>" />
